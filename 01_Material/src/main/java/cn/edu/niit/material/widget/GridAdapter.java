...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.ListHolder>{
    ...
    int icons[] = {R.drawable.g1,R.drawable.g2,R.drawable.g3,
            R.drawable.g4,R.drawable.g5,R.drawable.g6,
            R.drawable.g7,R.drawable.g9,R.drawable.g10,
            R.drawable.g11,R.drawable.g12,R.drawable.g13,
            R.drawable.g14,R.drawable.g15,R.drawable.g16,
            R.drawable.g17,R.drawable.g18,R.drawable.g19,
            R.drawable.g20,R.drawable.g21,R.drawable.g22,
            R.drawable.g23,R.drawable.g24,R.drawable.g25,
            R.drawable.g26,R.drawable.g27,R.drawable.g28,R.drawable.g29,};

    String names[] = {"浏览器","输入法","健康","效率","教育","理财","阅读","影音",
            "个性化","购物","资讯","生活","工具","出行","通讯","拍照","社交","安全",
            "休闲","棋牌","益智","射击","体育","儿童","网游","角色","策略","经营","竞速"};
    Context context;
    boolean flag;
